...
class DecoderLayer(Module):
    def __init__(self, d_model=512, d_k=128, d_v=128, h=4, d_ff=2048, dropout=.1, self_att_module=None,
...
class TransformerDecoderLayer(Module):
    def __init__(self, vocab_size, max_len, N_dec, padding_idx, d_model=512, d_k=128, d_v=128, h=4, d_ff=2048, dropout=.1,
